...
const INITIAL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "Hacer crecer MarLab — agencia/empresa. Pipeline comercial, prospectos, propuestas, cierres y expansión de cartera de clientes.",
    status: "activo",
    color: "#f59e0b",
    nextAction: "Definir meta mensual de ingresos + pipeline activo de prospectos",
    kpis: [
      { label: "Meta mensual",    value: "—"    },
      { label: "Prospectos",      value: "—"    },
      { label: "Propuestas",      value: "—"    },
      { label: "Cierres este mes", value: "—"   },
    ],
    tasks: [
      { id: "m1", text: "Definir meta de ingresos mensuales 2026",         done: false },
      { id: "m2", text: "Listar prospectos activos en pipeline",            done: false },
      { id: "m3", text: "Configurar proceso de seguimiento semanal",        done: false },
      { id: "m4", text: "Movimiento comercial semanal — mín 1 acción/día", done: false },
      { id: "m5", text: "Conectar Financial OS con ingresos de MarLab",    done: false },
    ],
    updatedAt: "2026-05-20",
  },
];
